---
title: "NewFeature Movie Genre Validator"
runtime: shiny
output: 
...
url <- "https://demo.dominodatalab.com:443/models/604a1c0a6d0e8a21df79ccca/latest/model"
...
genres_response <- eventReactive(input$goButton, {
  POST(
    url,
   authenticate("UFcZv3L05voSxag3rH91u5veoJLrlZ7ffQwv9z68RFvdZl3178nxiFAuaqxY0bRk", "UFcZv3L05voSxag3rH91u5veoJLrlZ7ffQwv9z68RFvdZl3178nxiFAuaqxY0bRk", type = "basic"),
