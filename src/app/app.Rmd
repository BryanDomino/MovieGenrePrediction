...
url <- "https://demo.dominodatalab.com:443/models/604a7c366d0e8a21df79d16a/latest/model"
...
genres_response <- eventReactive(input$goButton, {
  POST(
    url,
   authenticate("hyassBbV6BdvMcl8NXcuqlfqjVwhkI0taTSjehiqfMiNQpUwywCG7wUvbeISHmxv", "hyassBbV6BdvMcl8NXcuqlfqjVwhkI0taTSjehiqfMiNQpUwywCG7wUvbeISHmxv", type = "basic"),
